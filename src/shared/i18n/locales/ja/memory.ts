export default {
  title: "メモリ",
  subtitle:
    "SI Agent がセッションを跨いで覚えているあなたと環境に関する情報です。",
  sessions: "セッション",
  messages: "メッセージ",
  memories: "メモリ",
  ...
  noMemoriesYet:
    "まだメモリがありません。SI Agent はチャットを通じて重要な事実を保存します。",
  noMemoryEntries: "メモリエントリがまだありません。",
  noToolsetsFound: "ツールセットが見つかりません。",
  addManuallyHint: "上のボタンから手動でメモリを追加することもできます。",
  userProfileHint:
    "あなた自身について SI Agent に教えてください — 名前、役割、好み、コミュニケーションスタイルなど。",
  providersHint:
    "プラガブルなメモリプロバイダは SI Agent に高度な長期記憶を与えます。組み込みメモリ（上）は選択したプロバイダと並行して常時動作します。",
