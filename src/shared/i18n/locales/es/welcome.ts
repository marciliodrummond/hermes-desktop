export default {
  ...
  dividerOr: "o",
  connectRemote: "Conectarse a SI Agent remoto",
  connectRemoteTitle: "Conectarse a SI Agent remoto",
  connectRemoteSubtitle:
    "Introduce la URL de un servidor de API de SI Agent en ejecución.",
