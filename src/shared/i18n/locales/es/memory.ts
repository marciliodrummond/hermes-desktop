export default {
  title: "Memoria",
  subtitle: "Lo que SI Agent recuerda sobre ti y tu entorno entre sesiones.",
  sessions: "Sesiones",
  messages: "Mensajes",
  memories: "Recuerdos",
  ...
  noMemoriesYet:
    "Todavía no hay recuerdos. SI Agent guardará los datos importantes mientras chateas.",
  ...
  userProfileHint:
    "Cuéntale a SI Agent sobre ti: nombre, rol, preferencias y estilo de comunicación.",
  providersHint:
    "Los proveedores de memoria conectables ofrecen a SI Agent memoria avanzada a largo plazo. La memoria integrada (arriba) siempre está activa junto con el proveedor seleccionado.",
