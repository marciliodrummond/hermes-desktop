export default {
  title: "记忆",
  subtitle: "SI Agent 在不同会话之间记住的关于你和环境的信息。",
  sessions: "会话",
  messages: "消息",
  memories: "记忆",
  ...
  noMemoriesYet: "还没有记忆。SI Agent 会在你聊天时保存重要信息。",
  noMemoryEntries: "暂无记忆条目。",
  noToolsetsFound: "未找到工具集。",
  addManuallyHint: "你也可以使用上面的按钮手动添加记忆。",
  userProfileHint: "告诉 SI Agent 关于你的信息 — 姓名、角色、偏好、沟通风格。",
  providersHint:
    "可插拔的记忆提供商为 SI Agent 提供高级长期记忆。内置记忆(上方)始终与所选提供商一起激活。",
