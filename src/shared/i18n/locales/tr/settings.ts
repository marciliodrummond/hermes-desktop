export default {
  ...
  analytics: {
    ...
    hint: "SI Agent'ı iyileştirmeye yardımcı olmak için anonim, toplulaştırılmış kullanım verilerini projenin PostHog örneğine gönderir. İstediğiniz zaman kapatabilirsiniz.",
    disclosure: {
  ...
  updateSuccess: "SI Agent başarıyla güncellendi.",
  ...
  poolHint:
    "Otomatik dönüşüm ve yük dengelemesi için aynı sağlayıcıya birden çok API Anahtarı ekleyin. SI Agent bunlar arasında geçiş yapacaktır.",
  add: "Ekle",
  remove: "Kaldır",
  keyLabel: "Anahtar",
  empty: "(boş)",
  dataSection: "Veri",
  dataHint:
    "SI Agent yapılandırmanızı, oturumlarınızı, yeteneklerinizi ve belleğinizi dışa veya içe aktarın.",
  ...
  migrationDesc:
    "<code>{{path}}</code> adresinde OpenClaw bulundu. Yapılandırmanızı, API anahtarlarınızı, oturumlarınızı ve yeteneklerinizi SI Agent'e taşıyabilirsiniz.",
  migrationDismiss: "Tekrar gösterme",
  migrating: "Taşınıyor...",
  migrateToHermes: "SI Agent'e Taşı",
  skip: "Geç",
  ...
  modeLocal: "Yerel",
  modeRemote: "Uzak",
  modeLocalHint: "Bu cihazda yüklü SI Agent kullanılıyor",
  modeRemoteHint:
    "Ağınızdaki veya buluttaki bir SI Agent API sunucusuna bağlanın",
  remoteUrl: "Uzak URL",
  remoteUrlHint:
    "SI Agent API sunucusu URL'si (/health ve /v1/chat/completions endpoint'lerini sunmalıdır)",
  ...
  serverConfigHint:
    "Uzak bir SI Agent sunucusuna bağlandınız. Model seçimi, sağlayıcı API anahtarları ve kimlik bilgileri sunucunun <code>~/.hermes/.env</code> ve <code>config.yaml</code> dosyalarında yönetilir. Bunları ana bilgisayarda düzenleyin (örn. <code>docker exec -it hermes vi /opt/data/.env</code>) ve kabı yeniden başlatın.",
  connectionMode: "Mod",
  switchedToLocal: "Yerel moda geçildi",

  // Community
  communityTitle: "Topluluk",
  communityHint: "Sorular sormak, sorunları bildirmek ve diğer SI Agent kullanıcılarıyla sohbet etmek için Discord kanalımıza katılın.",
  joinDiscord: "Discord Kanalına Katıl",

  // SSH & Server Config
  modeSsh: "SSH Tüneli",
  modeSshHint: "SSH üzerinden uzak bir SI Agent'e tünel oluşturun — açık bağlantı noktası veya API anahtarı gerekmez.",
  ...
  remoteEnvDesc: "Uzak mod: uzak SI Agent sunucunuzdaki .env dosyasına API_SERVER_KEY=<anahtarınız> ekleyin, ardından gateway'i yeniden başlatın.",
  ...
  sshRemotePort: "Uzak SI Agent Portu",
  ...
  sshSubtitle: "SSH üzerinden uzak bir SI Agent'e tünel oluşturun — açık bağlantı noktası veya API anahtarı gerekmez.",
  ...
  sshErrorConnection: "SSH üzerinden bağlanılamadı veya uzaktaki SI Agent'e ulaşılamadı. Şunlardan emin olun:\n• SSH anahtarı doğru (veya varsayılan ~/.ssh/id_rsa çalışıyor)\n• Uzak sunucuda SI Agent gateway'i çalışıyor\n• Uzak port doğru (varsayılan 8642)",
