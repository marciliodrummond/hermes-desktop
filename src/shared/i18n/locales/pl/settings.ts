export default {
  ...
  analytics: {
    ...
    hint: "Pomaga ulepszać SI Agent przez wysyłanie anonimowych, zagregowanych danych użycia do instancji PostHog projektu. Możesz to wyłączyć w dowolnym momencie.",
    disclosure: {
  ...
  updateSuccess: "SI Agent został pomyślnie zaktualizowany.",
  ...
  poolHint:
    "Dodaj wiele kluczy API dla tego samego dostawcy, aby automatycznie rotować i równoważyć obciążenie. SI Agent będzie ich używał cyklicznie.",
  add: "Dodaj",
  remove: "Usuń",
  keyLabel: "Klucz",
  empty: "(puste)",
  dataSection: "Dane",
  dataHint:
    "Eksportuj lub importuj konfigurację SI Agent, sesje, umiejętności i pamięć.",
  ...
  migrationDesc:
    "Znaleziono OpenClaw w <code>{{path}}</code>. Możesz przenieść konfigurację, klucze API, sesje i umiejętności do SI Agent.",
  migrationDismiss: "Nie pokazuj ponownie",
  migrating: "Migrowanie...",
  migrateToHermes: "Migruj do SI Agent",
  skip: "Pomiń",
  ...
  modeLocal: "Lokalny",
  modeRemote: "Zdalny",
  modeLocalHint: "Używasz SI Agent zainstalowanego na tym urządzeniu",
  modeRemoteHint: "Połącz z serwerem API SI Agent w sieci lub chmurze",
  remoteUrl: "Zdalny URL",
  remoteUrlHint:
    "URL serwera API SI Agent (musi wystawiać /health i /v1/chat/completions)",
  ...
  serverConfigHint:
    "Jesteś połączony ze zdalnym serwerem SI Agent. Wybór modelu, klucze API dostawców i poświadczenia są zarządzane na serwerze w <code>~/.hermes/.env</code> oraz <code>config.yaml</code>. Edytuj je na hoście (np. <code>docker exec -it hermes vi /opt/data/.env</code>) i zrestartuj kontener.",
  connectionMode: "Tryb",
