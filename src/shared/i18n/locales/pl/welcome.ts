export default {
  ...
  dividerOr: "lub",
  connectRemote: "Połącz ze zdalnym SI Agent",
  connectRemoteTitle: "Połącz ze zdalnym SI Agent",
  connectRemoteSubtitle: "Podaj URL działającego serwera API SI Agent.",
