export default {
  ...
  dataSection: "Dados",
  dataHint:
    "Salve uma cópia ou recupere suas configurações, histórico, habilidades e memória do Hermes.",
  ...
  skip: "Pular",
  appearanceHint: "Deixe a aparência do app do jeito que você prefere",
  ...
  generateKey: "Gerar e salvar uma chave para mim",
  generating: "Gerando…",
