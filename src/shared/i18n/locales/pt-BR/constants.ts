export default {
  ...
  openaiCodexDesc: "Entra com seu login OAuth do Codex",
  openaiCodexTag: "Não precisa de API key",
  ...
  auxiliaryCompression: "Compressão",
  ...
  auxiliaryTitleGeneration: "Criar títulos",
  auxiliaryTitleGenerationHint: "títulos das conversas",
  ...
  auxiliaryCuratorHint: "revisão do uso das habilidades",
  auxiliaryAuto: "auto",
  ...
  telegramBotHint: "Peça ao @BotFather no Telegram",
  ...
  emailPassHint: "Use uma senha de app, não a senha normal da sua conta",
