export default {
  title: "Memory",
  subtitle:
    "What SI Agent remembers about you and your environment across sessions.",
  sessions: "Sessions",
  messages: "Messages",
  memories: "Memories",
  ...
  noMemoriesYet:
    "No memories yet. SI Agent will save important facts as you chat.",
  ...
  userProfileHint:
    "Tell SI Agent about yourself — name, role, preferences, communication style.",
  providersHint:
    "Pluggable memory providers give SI Agent advanced long-term memory. Built-in memory (above) is always active alongside the selected provider.",
