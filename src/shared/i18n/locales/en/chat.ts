export default {
  ...
  reasoningEffort: {
    ...
    auto: "Auto",
    autoDescription: "Let SI Agent and the model decide.",
  ...
  deny: "Deny",
  clarify: {
    defaultQuestion: "SI Agent needs your input.",
    placeholder: "Type your answer…  (Ctrl+Enter to send)",
    send: "Send",
    skip: "Skip — let SI Agent decide",
    skipped: "Skipped — SI Agent decided",
