export default {
  ...
  analytics: {
    ...
    hint: "Helps improve SI Agent by sending anonymous, aggregated usage data to the project's PostHog instance. You can turn this off at any time.",
    disclosure: {
  ...
  updateSuccess: "SI Agent updated successfully.",
  ...
  poolHint:
    "Add multiple API Keys for the same provider for automatic rotation and load balancing. SI Agent will cycle through them.",
  add: "Add",
  remove: "Remove",
  keyLabel: "Key",
  empty: "(empty)",
  dataSection: "Data",
  dataHint:
    "Export or import your SI Agent configuration, sessions, skills, and memory.",
  ...
  migrationDesc:
    "Found OpenClaw at <code>{{path}}</code>. You can migrate your configuration, API keys, sessions, and skills to SI Agent.",
  migrationDismiss: "Don't show again",
  migrating: "Migrating...",
  migrateToHermes: "Migrate to SI Agent",
  skip: "Skip",
  ...
  modeLocal: "Local",
  modeRemote: "Remote",
  modeLocalHint: "Using SI Agent installed on this device",
  modeRemoteHint: "Connect to a SI Agent API server on your network or cloud",
  remoteUrl: "Remote URL",
  remoteUrlHint:
    "The SI Agent API server URL (must expose /health and /v1/chat/completions)",
  ...
  serverConfigHint:
    "You&apos;re connected to a remote SI Agent server. Model selection, provider API keys, and credentials are managed on the server&apos;s <code>~/.hermes/.env</code> and <code>config.yaml</code>. Edit them on the host (e.g. <code>docker exec -it hermes vi /opt/data/.env</code>) and restart the container.",
  connectionMode: "Mode",
  switchedToLocal: "Switched to local mode",

  // Community
  communityTitle: "Community",
  communityHint: "Join our Discord channel to ask questions, report issues, and chat with other SI Agent users.",
  joinDiscord: "Join Discord Channel",

  // SSH & Server Config
  modeSsh: "SSH Tunnel",
  modeSshHint: "Tunnel to a remote SI Agent over SSH — no exposed ports or API keys needed.",
  ...
  remoteEnvDesc: "Remote mode: add API_SERVER_KEY=<your-key> to the .env on your remote SI Agent server, then restart the gateway.",
  sshHost: "SSH Host",
  sshPort: "SSH Port",
  sshUsername: "Username",
  sshKeyPath: "Private Key Path",
  sshKeyPathOptional: "(optional, defaults to ~/.ssh/id_rsa)",
  sshRemotePort: "Remote SI Agent Port",
  ...
  sshSubtitle: "Tunnel to a remote SI Agent over SSH — no exposed ports or API keys needed.",
  ...
  sshErrorConnection: "Could not connect via SSH or reach SI Agent on the remote. Make sure:\n• SSH key is correct (or default ~/.ssh/id_rsa works)\n• SI Agent gateway is running on the remote\n• The remote port is correct (default 8642)",
