export default {
  ...
  dividerOr: "or",
  connectRemote: "Connect to Remote SI Agent",
  connectRemoteTitle: "Connect to Remote SI Agent",
  connectRemoteSubtitle: "Enter the URL of a running SI Agent API server.",
