export default {
  ...
  analytics: {
    ...
    hint: "Ajuda a melhorar o SI Agent ao enviar dados de utilização anónimos e agregados para a instância PostHog do projecto (alojada na UE). Pode desactivar a qualquer momento.",
    disclosure: {
  ...
  updateSuccess: "SI Agent actualizado com sucesso.",
  ...
  poolHint:
    "Adicione várias chaves de API para o mesmo fornecedor para rotação automática e balanceamento de carga. O SI Agent alternará entre elas.",
  add: "Adicionar",
  remove: "Remover",
  keyLabel: "Chave",
  empty: "(vazio)",
  dataSection: "Dados",
  dataHint:
    "Exporte ou importe a sua configuração do SI Agent, sessões, competências e memória.",
  ...
  migrationDesc:
    "Encontrámos o OpenClaw em <code>{{path}}</code>. Pode migrar a sua configuração, chaves de API, sessões e competências para o SI Agent.",
  migrationDismiss: "Não mostrar novamente",
  migrating: "A migrar...",
  migrateToHermes: "Migrar para o SI Agent",
  skip: "Ignorar",
  ...
  modeLocal: "Local",
  modeRemote: "Remoto",
  modeLocalHint: "A usar o SI Agent instalado neste dispositivo",
  modeRemoteHint: "Ligar a um servidor da API do SI Agent na sua rede ou nuvem",
  remoteUrl: "URL Remoto",
  remoteUrlHint:
    "O URL do servidor da API do SI Agent (deve expor /health e /v1/chat/completions)",
  ...
  serverConfigHint:
    "Está ligado a um servidor remoto do SI Agent. A selecção de modelos, as chaves de API dos fornecedores e as credenciais são geridas no host remoto em <code>~/.hermes/.env</code> e <code>config.yaml</code>. Edite-os aí e reinicie o servidor.",
  connectionMode: "Modo",
