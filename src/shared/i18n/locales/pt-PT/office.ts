export default {
  ...
  setupDesc1:
    "O Claw3D é um ambiente de visualização 3D para os seus agentes SI Agent. Permite-lhe ver os seus agentes a trabalhar num espaço de escritório interactivo.",
  setupDesc2:
