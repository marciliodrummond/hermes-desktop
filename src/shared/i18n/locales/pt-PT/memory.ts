export default {
  title: "Memória",
  subtitle: "O que o SI Agent se lembra sobre si e o seu ambiente entre sessões.",
  sessions: "Sessões",
  messages: "Mensagens",
  memories: "Memórias",
  ...
  noMemoriesYet:
    "Ainda sem memórias. O SI Agent guardará factos importantes à medida que conversam.",
  ...
  userProfileHint:
    "Fale ao SI Agent sobre si — nome, cargo, preferências, estilo de comunicação.",
  providersHint:
    "Fornecedores de memória modular dão ao SI Agent uma memória de longo prazo avançada. A memória integrada (acima) está sempre activa em conjunto com o fornecedor seleccionado.",
