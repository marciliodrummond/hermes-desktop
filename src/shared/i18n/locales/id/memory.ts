export default {
  title: "Memori",
  subtitle:
    "Hal yang diingat SI Agent tentang Anda dan lingkungan Anda di berbagai sesi.",
  sessions: "Sesi",
  messages: "Pesan",
  memories: "Memori",
  ...
  noMemoriesYet:
    "Belum ada memori. SI Agent akan menyimpan fakta penting saat Anda chat.",
  ...
  userProfileHint:
    "Beri tahu SI Agent tentang diri Anda - nama, peran, preferensi, dan gaya komunikasi.",
  providersHint:
    "Provider memori pluggable memberi SI Agent memori jangka panjang yang lebih canggih. Memori bawaan (di atas) selalu aktif bersama provider yang dipilih.",
