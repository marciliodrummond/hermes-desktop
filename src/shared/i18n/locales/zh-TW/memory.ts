export default {
  title: "記憶",
  subtitle: "SI Agent 在不同工作階段之間記住的關於你和環境的資訊。",
  sessions: "工作階段",
  messages: "訊息",
  memories: "記憶",
  ...
  noMemoriesYet: "還沒有記憶。SI Agent 會在你聊天時儲存重要資訊。",
  noMemoryEntries: "目前沒有記憶條目。",
  noToolsetsFound: "找不到工具集。",
  addManuallyHint: "你也可以使用上面的按鈕手動新增記憶。",
  userProfileHint: "告訴 SI Agent 關於你的資訊，姓名、角色、偏好、溝通風格。",
  providersHint:
    "可插拔的記憶供應商為 SI Agent 提供進階長期記憶。內建記憶（上方）始終與所選供應商一起啟用。",
